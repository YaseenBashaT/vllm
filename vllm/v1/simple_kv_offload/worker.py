...
def _kv_cache_block_regions(
    ...
    for name, tensor in kv_caches.items():
        ...
        # In block-major storages every layer's stride spans the whole
        # per-block window; a layer's view starts at its page offset within
        # the first window, but its region is the window itself.
